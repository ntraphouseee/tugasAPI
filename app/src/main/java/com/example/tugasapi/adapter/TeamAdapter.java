...
public class TeamAdapter extends RecyclerView.Adapter<TeamAdapter.ViewHolder> {
    private final List<com.example.tugasapi.model.Team> teamList;

    public TeamAdapter(List<com.example.tugasapi.model.Team> teamList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.tugasapi.model.Team team = teamList.get(position);
    ...
    public void updateData(List<com.example.tugasapi.model.Team> newTeams) {
        teamList.clear();
